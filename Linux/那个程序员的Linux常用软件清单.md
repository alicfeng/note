>记得刚开始接触Linux的时候是大学二年级，使用Linux的时间也有一年多了，至于为何会接触到此系统呢，归于一个带我飞的大学同学**左蓝**。在这一年多的时间里，使用的最多的Linux系统是基于debian发行版系列的Ubuntu，对于它的简介呢，那就[维基百科ubuntu](https://zh.wikipedia.org/wiki/Ubuntu)。我旨在记录并分享我在ubuntu的深渊使用过并觉得推荐的应用或工具，要是你有更好的推荐希望留言或简信，THX~~~
